...
(function($, window, document, undefined) {
  ...
  runCode.prototype = {
    init: function() {
      var dialog = '<div class="preview-wrap"><div class="inner"><div class="bar"><span>Html</span><span>Result</span><button class="btn-preview">预览</button><label class="label"><input class="watch-code" type="checkbox">自动运行</label><i class="btn-close-view"><image src="runcode/return.png"/></i></div><div class="con"><pre><code id="codeContent" contenteditable name="editcode" class="js"></code></pre><iframe id="preview" frameborder="0"></iframe></div></div></div>';
